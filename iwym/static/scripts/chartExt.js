...
var HighStockChart = function (divID, result, crrentData) {
    ...
    //定义数组
    var ohlcArray = [], volumeArray = [], MA5Array = [], MA10Array = [], MA20Array = [], MA30Array = [],
        zdfArray = [], zdeArray = [], hslArray = [], data = [], dataLength, dailyData = [];
    /*
...
//		}
    ...
    for (var i = 0; i < dataLength; i++) {
        ...
        data[i][0] = date;      // 将数字日期写回data, 改全局变量后续会用到
        ohlcArray.push([
            date,       // the date
            data[i][1], // open
            data[i][2], // high
